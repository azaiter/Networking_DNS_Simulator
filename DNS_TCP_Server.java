...
public class DNS_TCP_Server {
    public static void main(String[] args) {
        ...
        try {
            ...
            RandomAccessFile randomAccessFile = new RandomAccessFile(DNS_Utils.TCP_RAF_FILENAME, "rw");
            ...
            while(true){
                ...
                new Thread(()->{
                    try {
                        ...
                        System.out.println("I/O ERROR: Client disconnected?");
                        DNS_Utils.setClientCount(randomAccessFile, DNS_Utils.getClientCount(randomAccessFile, 0)-1, 0);
                    }
                }).start();
            }
            ...
            System.out.println("ERROR: RAF File not found!");
        }
        catch (Exception e) {
            System.out.println("ERROR: Can't initialize the TCP socket, or failed to do handshake with client!");
        }
    }
}
